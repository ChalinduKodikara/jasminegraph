...
print("============nodes" + str(path_nodes_localstore))
...
print("============edges" + str(path_edges_localstore))

path_nodes_centralstore = args['path_localstore'] + args['graph_id'] + '_centralstore_attributes_' + args['partition_id']
