...
public:
    ...
    void initiateStreamingDistributedLearning(SQLiteDBInterface sqlite);
    ...
    static bool initiateStreamingServer(string host, int port, int dataPort, string partitionID);

    static bool initiateStreamingClient(string host, int port, int dataPort, string partitionID);
};
